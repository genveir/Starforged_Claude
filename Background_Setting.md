...
The cordon navy's size — formidable by any measure — is increasingly difficult to justify against a threat that has not materialised in decades. The cynical read, gaining traction each generation, is that their size has less to do with the blight and more to do with the industrial assets sitting inside the cordon.
...
But in the century since, the tradition has also evolved into something smaller in scope. A cordon vow — lowercase, personal, named after the original — is a formal declaration of intent sworn by navy personnel when they commit to something that matters. The formula is fixed: *"I swear by the cordon that keeps us safe that..."* followed by the specific commitment. A ship's computer logs it automatically against the swearer's record. The witnesses present are implicit — anyone within earshot counts. There is no ceremony beyond the words themselves and the silence that follows them.

Breaking *the* Cordon Vow — the original, the one every cordon navy person still carries in their record — is treason. The navy will find you and execute you. High profile cases are taught in navy schools.
