# The Current State of the Divide
...
The scientific and engineering knowledge base of humanity is substantially intact. The industrial capacity to act on that knowledge is not.

Any administrator can look up the specifications for a fusion reactor. Sourcing every component in the production chain required to build one is another matter. Pre-cataclysm technology depended on thousands of interdependent specialised manufacturing steps, each requiring its own facilities, materials, and expertise. No single settlement has the population, capital, or market to justify rebuilding those chains from scratch. The result is a civilisation that understands its own technology in theory but cannot fully replicate it in practice.

What this means concretely:

**Medicine** is good at the point of care. A hospital in a planetary city has autodocs, can treat cancer, can perform complex surgery with automated assistance. The scientific knowledge to train doctors and produce medicines in meaningful quantities exists and is being used. A settler on a remote asteroid has antibiotics, painkillers, and basic surgical capability. The gap is access, not knowledge.
...
Navy people are born and raised in space. Ships and stations are home. Planets are places you visit. Their culture is professional, hierarchical, and militaristic. They value merit. However, navy children are trained from birth for navy roles, given educational and practical advantages unavailable to planetary civilians, and then evaluated against those civilians on criteria the navy designed. The gap between the self-image of a merit-based institution and the reality of an inherited military aristocracy is visible to outside observers and to honest insiders, and is a source of ongoing internal tension.
...
In the cordon navies, the dedication to merit is genuine. An admiral's son or daughter has the same chances as the son or daughter of a master at arms to be accepted into the ranks. Both have much better chances to get in than a civilian that was not trained for a navy role through his or her entire education. All have the same chances of advancement afterwards. In the planetary navies this commitment may be less strict, depending on the specific faction.
...
The cordon navy's size — formidable by any measure — is increasingly difficult to justify against a threat that has not materialised in decades. The blight is a much lesser threat now than it was fifty years ago, but the size of the cordon navies has remained constant. Admitting that downscaling would be justified would cost the navies power, influence, and diminish the justification for the food tax they've imposed on everyone else.

**The Planetary Navy Factions** are the descendants of fleet elements that broke away from the unified structure to anchor themselves to specific systems. The spectrum runs from genuine governing institutions — professional, relatively accountable, actively working to improve conditions on their planets — to effectively warlord states that have learned the right vocabulary of public service. Most fall somewhere between these poles, with the balance shifting over time depending on leadership and circumstance.

Planetary navy factions provide their worlds with organisational competence and technological capability that civilian governments struggle to match. In exchange they extract loyalty, labour, and political authority. Their planets tend to have sparse urban development — surpluses flow upward to the fleet rather than into local specialisation — but the populations generally have access to better tools, medicine, and security than comparable civilian-governed worlds.

Relations between cordon and planetary factions are structurally tense. The cordon resents the planetary factions for abandoning the quarantine mission while continuing to benefit from it. The planetary factions resent the cordon for taxing their hard-built worlds as if they were supply depots. Coalitions form and shift along these fault lines, and the occasional dispute over a contested system or a particularly resented tax demand escalates into something more serious.

---

## Civilian Society

Everyone who is not navy is civilian, which is most of humanity.

Civilian settlers live on planets. Space is somewhere you travel, not somewhere you live. Their relationship with the navy factions above them ranges from genuine appreciation to sullen resentment depending on which faction, which planet, and which generation you're asking. The navy's technological and organisational advantages are real and often genuinely beneficial. The power asymmetry is also real and impossible to ignore.

Planetary nations are generally small by pre-cataclysm standards — tens of thousands to tens of millions of people, bounded by solar systems, sometimes multiple nations sharing a single system. Urban centres exist where surpluses have allowed specialisation. Rural regions are vast, under-policed, and substantially self-governing in practice. A government may theoretically administer a territory the size of a continent with a single appointed authority figure who enforces law by personal reputation and the willingness of locals to be deputised.
...
Law exists on nested levels that do not always agree with each other.

At the broadest level, a common legal heritage from the origin systems provides a shared baseline — categories of crime that every faction nominally agrees cross a line, most importantly mass atrocity and genocide. The navy factions are the de facto enforcers of this baseline, not because anyone elected them but because they have the ships. Their interventions are selective, reluctant, and always temporary — they will disarm, set terms, and leave. Whether the terms hold depends on follow-through from the aggrieved party and the navy's ongoing willingness to care. Two navy factions disagreeing about an intervention is its own category of crisis.

Within navy factions, law is professional and institutional. Police, courts, lawyers, judges — a recognisable if militarised justice system. Within planetary nations, legal quality scales directly with resources and population density. Cities have recognisable law enforcement, stretched thin. Rural regions get a marshal with vast theoretical jurisdiction and practical authority limited to what they can personally enforce. The frontier gets nothing.
...
The central tension is between the scale of what was lost and the stubborn, unheroic persistence of people trying to build something worth having in its place. Better times are coming. They are a very long way away. The people alive now will not see them. They build anyway.