...
Approximately a day's walk from the settlement, a mining complex sits in a crater on the moon's surface, connected to the settlement by a service track navigable by buggy. Roughly sixty of the settlement's miners are stationed there, working extraction and survey operations.
...
**Aran Chrion** — merc sergeant. Broad, unhurried, with the deliberate quality of someone who uses cruelty and discomfort as a tool. Has authority over the rank and file mercenaries and appears to enjoy exercising it. Current status: no direct interaction with Gerald to date.
...
Members: Gerald Finch, Carl Inswich, Davel Oren, Hamzi, Sandra Vael, Maria Reyes.
