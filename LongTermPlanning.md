...
The commando operation: the raiders have concluded that the cabin ambush was a commando action by Steady Return personnel. They are correct — Gerald is a Steady Return operative, inserted covertly, who has been running active operations since arrival. What Gerald can exploit is the gap between what is true and what the officer can verify: the officer knows a dangerous operative was on the ground but does not know he stayed moon-side at the shuttle's departure, or that he had local allies. Gerald can amplify the officer's existing read until the pressure of that belief forces a decision that creates an opening.
